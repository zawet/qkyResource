...
define({
	navdata:{/*导航数据*/
		...
		themetype:{
			pjnameColor:"#04aef7",//应用名颜色
			navactiveColor:"#04aef7"//主导航活动时背景色
		},//个性定制专属的应用名颜色和主导航选中颜色
		distclass:["navbar", "navbar-fixed-top", "headernav"],//默认一定要用的class
		navli_j:[
			{name:"首页",attrcont:"href='index.html'",isactive:true},
			{name:"公共资源库",attrcont:"href='index_com.html'",isactive:false},
			{name:"我的资源库",attrcont:"href='index_my.html'",isactive:false},
			{name:"云盘",attrcont:"href='index_cloud.html'",isactive:false}
		],//主导航条
		...
		tea_info:{"name":"全课云运营学校教师 关瑞荣","isphoto":false,"photo":"images/tx01.png"},//个人信息
